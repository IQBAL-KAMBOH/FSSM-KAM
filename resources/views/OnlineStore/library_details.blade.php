    ...
    <hr class="m-0 pt-2 mt-2">
                        ...
                        <div class="col-lg-12 mt-3">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <a type="button" onclick="checkLogin({{$data->id}},'digital_product','{{$data->name}}',{{$data->sale_price}},{{$data->dp ?? 0}},{{$data->bv ?? 0}},'{{$data->supplier_name}}','{{$data->supplier_number}}','{{$data->account_type}}',1,{{$data->custom_id ?? 1}},{{$data->delivery_charges ?? 0}},'{{$type}}')" class="btn btn-success w-100 text-light">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
