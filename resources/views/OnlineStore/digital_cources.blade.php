@include('OnlineStore.includes.header2')
      ...
      <div class="fashion_section">
         <div id="section_{{$section->name}}" class="carousel slide main_slider" data-ride="carousel">
           ...
           <div class="row  justify-content-center">
                           <?php 
                                ...
                                $getproducts=App\Http\Controllers\Store\StoreController::getCourcesAll($section->id);
                
                          ?>
                           @foreach($getproducts as $product)
                           
                           <div onclick="location.href = '/all-cources/{{$section->id}}';"  class="col-5 col-md-3 col-lg-2 m-2 p-1 rounded card shadow" style="border-radius:10px !important;">
         ...
         <div class="row">
                           <div class="col-12">
                              <center>
                                 <a href="/all-cources/{{$section->id}}" class="btn btn-primary mt-4">
                                    View More
