...
@include('OnlineStore.includes.poster')
      ...
      <?php 
          ...
          $countproducts=App\Http\Controllers\Store\ProductController::countProductChunks($section->id,3);
                     ...
                     <div class="fashion_section_2">
                        <div class="row">
                           <?php 
                                ...
                                $getproducts=App\Http\Controllers\Store\StoreController::getProducts($section->id,3,$i);
                          ...
                          ?>
                           ...
                           <div class="col-lg-4 col-sm-4 col-12">
                              <div class="box_main">
                                 <h6 class="shirt_text" style="font-size:14px;">{{$product->name}}</h6>
                                 ...
                                 <div class="tshirt_img"><img src="{{$product->image}}"  style="max-height:200px !important;max-width:200px !important; border-radius: 10px;box-shadow: 5px 5px 5px black;"></div>
                                 <div class="btn_main">
                               
                                    <div class="buy_bt"><a class="btn" onclick="checkLogin({{$product->id}},'physical_product','{{$product->name}}',{{$product->sale_price}},{{$product->dp ?? 0}},{{$product->bv ?? 0}},'{{$product->supplier_name}}','{{$product->supplier_number}}','{{$product->account_type}}')">Buy Now</a></div>
                                    <div class="seemore_bt"><a href="product-details/{{$product->id}}">See More</a></div>
                                 </div>
                              </div>
                           </div>
