...
@if($globalSettings->pannel_poster_status=='Active')     
         ...
         <div id="carouselExampleIndicators" style="max-width:<?=$globalSettings->pannel_poster_width?>px; border-radius: 15px; max-height: <?=$globalSettings->pannel_poster_height?>px; justify:center; text-align:center !important;" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner" >
                     ...
                     <img class="d-block w-100" style="max-width:<?=$globalSettings->pannel_poster_width?>px; border-radius: 15px; max-height: <?=$globalSettings->pannel_poster_height?>px; justify:center; " src="  {{$poster->image}}" alt="First slide">
                                        ...
                                        <div class="card-bottom-section">
                                           <div class="col-6 text-left">
                                              <form action="/affiliate-transfer" method="post">
                                                ...
                                                <input type="hidden" name="points" value="<?=number_format($dashboard->affiliate_wallet,2)?>" id="">
                                    ...
                                    <div class="account-box">
                                        <div class="info-box">
                                            ...
                                            <div class="balance-info">
                                                ...
                                                <button value="copy" id="copy_button" class="btn btn-success" onclick="copyToClipboard('inv_url')">Copy Affiliate marketing Link</button>
							                
                                            </div>
                                        </div>
                                        <div class="card-bottom-section">
                                        <?php $inv_url='/register?refral_name='.auth()->user()->name;?>
							                 <input type="text" class="form-control"  value="<?php echo url('/').$inv_url; ?>" name="" id="inv_url">
                            ...
                            <div class="widget widget-card-five kg21">
                                <div class="widget-content">
                                    <div class="account-box">
                                        ...
                                        <div class="card-bottom-section">
                                        <div class="col-6 text-light"><h6 class="text-light">Unilevel
...
style="fill:#40C057;">
    <path d="M14.147,19.267c-0.188,0.188-0.442,0.293-0.707,0.293s-0.52-0.105-0.707-0.293L9.28,15.814 c-0.391-0.391-0.391-1.023,0-1.414c0.391-0.391,1.023-0.391,1.414,0l2.746,2.746L25.674,4.911C25.318,4.364,24.702,4,24,4H6 C4.895,4,4,4.895,4,6v18c0,1.105,0.895,2,2,2h18c1.105,0,2-0.895,2-2V7.414L14.147,19.267z"></path>
                                        ...
                                        <div class="col-6 text-light"><h6 class="text-light">Auto Net
