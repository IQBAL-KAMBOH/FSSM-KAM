			...
			<form action="{{ route('transfer-points.store') }}" method="POST">
				...
				<div class="card mb-4">
					...
					<div class="card-body">
						...
						<input type="hidden" name="point_type" value="BV" id="">
						<div class="row">
							<div class="form-group mb-4">
						...
						<div class="row">
							<div class="form-group mb-4">
								<label for="name">Select Side</label>
								<select class="form-control" value="" name="side" id="side" required >
						...
						<div class="row">
							<div class="form-group mb-4">
								...
								<input type="text" class="form-control"  name="points" id="register_points" required placeholder="Points" />
							</div>
						</div>
						<hr/>
