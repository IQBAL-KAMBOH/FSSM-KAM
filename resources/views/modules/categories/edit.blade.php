                ...
                <div class="col-lg-12 col-12  layout-spacing">
                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <form action="{{ route('categories.update', $category->id) }}" class="m-3 p-3" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="form-group col-6 mb-2">
                                        ...
                                        <input type="number" class="form-control" name="priority" id="name" value="{{ $category->priority }}" placeholder="Enter number">
                                    </div>
                                </div> 
                                    <div class="form-group col-6 mb-2">
