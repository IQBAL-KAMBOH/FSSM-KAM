    ...
    <div class="middle-content container-xxl p-0">
        ...
        @endif
                        ...
                        <div class="widget-content widget-content-area">
                            <form action="{{ route('products.update', $product->id) }}" class="m-3 p-3" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="form-group col-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" name="supplier_name" id="supplier_name" value="{{ $product->supplier_name}}" placeholder="Enter Supplier Name">
                                    </div>
                                    <div class="form-group col-6 mb-2">
